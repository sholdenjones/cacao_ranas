...
# STEP 2- remove a second predictor variable

############# MODEL NO VEG, CC - nothing sig - AIC 99.51 ##############
...
```{r}
############# MODEL NO WATER - SINGULAR FIT ##############
# full model with glmer, no water, veg as R.E., poisson
mod_richness_no_water <- glmer(no_species ~ site_mean_CC_scaled +
                   forest_cover_400_scaled +
                   (1 | site_mean_veg_scaled)
                   (1 | Elevation),
              data = site_richness_local,
...
summary(mod_richness_no_water) # 
vif(mod_richness_no_water) # 
check_overdispersion(mod_richness_no_water) # 

# assess model fit using dHARMA
simulationOutput <- simulateResiduals(fittedModel = mod_richness_no_water)
plot(simulationOutput)
...
############# MODEL CC - SINGULAR FIT ##############
# model with glmer, only CC, veg as R.E., poisson
mod_CC <- glmer(no_species ~ site_mean_CC_scaled +
                   (1 | site_mean_veg_scaled) +
                   (1 | Elevation),
              data = site_richness_local,
              family = poisson())
...
summary(mod_richness_CC) # 
vif(mod_richness_CC) # 
check_overdispersion(mod_richness_CC) # 

# assess model fit using dHARMA
simulationOutput <- simulateResiduals(fittedModel = mod_richness_CC)
plot(simulationOutput)
...
############# MODEL NO WATER, NO VEG - SINGULAR FIT  ##############
# full model with glmer, no water, no veg., poisson
mod_richness_no_water_veg <- glmer(no_species ~ site_mean_CC_scaled +
                   forest_cover_400_scaled +
                   (1 | Elevation),
              data = site_richness_local,
              family = poisson())
...
summary(mod_richness_no_water_veg) # 
vif(mod_richness_no_water) # 
check_overdispersion(mod_richness_no_water) # 
...
############# MODEL NO WATER, NO VEG -  ##############
# full model with glmer, no water, no veg., poisson
mod_richness_no_water_veg <- glmer(no_species ~ site_mean_hoja_scaled +
                   forest_cover_400_scaled +
                   (1 | Elevation),
              data = site_richness_local,
              family = poisson())
...
# full model with glmer, no water, veg as R.E., poisson
mod_richness_no_water_RE <- glmer(no_species ~ site_mean_CC_scaled +
                   forest_cover_400_scaled,
              data = site_richness_local,
              family = poisson())
# boundary (singular) fit: see help('isSingular')
...
## what if we ran through richness at transect-level?
```{r}
####### HMMM ##########
# full model with glmer, pca_CC_hoja, veg as F.E., poisson
modfull_3 <- glmer(num_species ~ tran_mean_CC_scaled +
                   tran_mean_veg_scaled +
                   water_dist_scaled + 
                   forest_cover_400_scaled +
                   (1 | Sitio), 
...
# assess model fit using dHARMA
simulationOutput <- simulateResiduals(fittedModel = modfull_3)
plot(simulationOutput)
...
# full model with glmer, no water, veg as R.E., poisson
mod_richness_test <- glmer(no_species ~ site_mean_CC_scaled +
                   (1 | site_mean_veg_scaled),
              data = site_richness_local,
              family = poisson())
# boundary (singular) fit: see help('isSingular')
