...
```{r}
# canopy cover
ggplot(site_richness_local_all, aes(x = site_mean_CC, fill = Tipo)) +
  geom_histogram()

# hoja
ggplot(site_richness_local_all, aes(x = site_mean_hoja, fill = Tipo)) +
  geom_histogram()

# forest
ggplot(site_richness_local_all, aes(x = forest_cover_400, fill = Tipo)) +
  geom_histogram()

# water
ggplot(site_richness_local_all, aes(x = water_dist, fill = Tipo)) +
  geom_histogram()

# veg
ggplot(site_richness_local_all, aes(x = site_mean_veg, fill = Tipo)) +
  geom_histogram()

# elevation
ggplot(site_richness_local_all, aes(x = Elevation, fill = Tipo)) +
  geom_histogram()
```
