...
my_theme <- function() {
  theme_minimal() + 
   theme(legend.position = "none",
        ...
        axis.title = element_text(size = 16, color = "gray25"),
...
```{r}
### what happens if remove FLL-B dud site?
# diversity_by_site <- diversity_by_site %>%
#   filter(!Sitio == 'FLL-B')
...
accum_curves <- lapply(assemblages, function(x) specaccum(x, method = "random", permutations = 100))
...
# Loop through each assemblage to add its accumulation curve and confidence intervals to the plot
