...
```{r}
site_richness_local <- left_join(richness_by_site, local_by_site,
                                 by = c("Sitio")) %>%
...
site_richness_local <- site_richness_local %>%
  select(-c("species", "Transecto", "Fecha", "tran_mean_veg", "tran_mean_hoja",
            ...
            "veg_bins", "hoja_bins", "CC_bins", "year"))

# also add the elevation to this df - if working at site level, elevation as R.E.?
site_richness_local <- merge(site_richness_local, 
