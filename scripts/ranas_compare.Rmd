...
## LOOK HERE TO REVIEW IMPORT OF NEW_MAT - MAYBE DO MATRIX INSTEAD OF TIBBLE?
load data
```{r, include=FALSE}
...
new_mat <- read_csv(
  "data/processed_data/new_mat_processed.csv")
new_mat <- as_tibble(new_mat)

# may be running into issues above with new_mat, perhaps convert to matrix?
...
## WHY ARE NUMBERS INSTEAD OF SITES SHOWING?
```{r}
...
# use community by species matrix
