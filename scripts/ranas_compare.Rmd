...
simulationOutput <- simulateResiduals(fittedModel = richness_by_type_glm)
...
AOV sp. richness against harvested, non-harvested - highly sig!
```{r}
...
```{r}
par(mfrow = c(1, 2))  
# use par to generate panels with 1 row of 2 graphs
hist(simpson)
hist(shannon)
```
...
## NEXT STEP: RUN A POST-HOC TEST NEEDED FOR DIVERSITY INDICES
