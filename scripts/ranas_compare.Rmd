...
richness_by_site <- left_join(richness_by_site, site_type, by = "Sitio")
...
## NO SIG difference b/ween richness of bosque / viejo w/ elevation as random effect
...
## SIG higher richness in non-harvested sites
- using Poisson dist
...
## ADD ELEVATION AS RANDOM EFFECT HERE
