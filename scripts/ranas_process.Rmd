...
## HOLY SHIT _ MAYBE HUGE ERROR HERE?
# NEED TO USE COUNT NOT N_Distinct??!?!

## TEST:
# ```{r}
# # First, create the richness summary
# trans_richness <- ranas %>%
#   group_by(Sitio, Transecto, Fecha) %>%
#   summarize(num_species = n_distinct(Final_ID), .groups = 'drop')
# 
# # Then, ensure all combinations of Sitio, Transecto, and Fecha are represented
# trans_richness <- trans_richness %>%
#   complete(Sitio, Transecto, Fecha, fill = list(num_species = 0))
# 
# ```
