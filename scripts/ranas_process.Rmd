...
## next step is to add write_csv so its writing into processed_data folder
...
```{r}
# this will be consistent for each output
...
# make new df with only new ind
new <- ranas %>%
  filter(Recap == "N")

# use directory to make output processed csv
