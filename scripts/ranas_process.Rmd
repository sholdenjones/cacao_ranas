...
## NEED TO REVIEW HERE - HOW IS NEW_MAT GETTING EXPORTED? 
## NEED TO RETAIN ROW NAMES SOMEHOW FOR VISUALIZATION WITH VEGAN PACKAGE
...
# may need to change the write_csv to retain row names in export matrix?
# write.csv(new_mat, file = filepath, row.names = TRUE)
```
